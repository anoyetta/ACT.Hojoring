...
namespace FFXIV.Framework.WPF.Controls
{
    ...
    public class TextPath : Shape
    {
        ...
        protected override Geometry DefiningGeometry => this._textGeometry ?? Geometry.Empty;
        ...
        private void CreateTextGeometry()
        {
            ...
            this._textGeometry = formattedText.BuildGeometry(Origin);
        }
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            if (this._textGeometry.Bounds == Rect.Empty)
            {
                return new Size(0, 0);
            }
            ...
            return new Size(
                Math.Min(availableSize.Width, this._textGeometry.Bounds.Width),
                Math.Min(availableSize.Height, this._textGeometry.Bounds.Height));
        }
    }
}
