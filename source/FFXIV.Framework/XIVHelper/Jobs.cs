...
namespace FFXIV.Framework.XIVHelper
{
    ...
    public class Jobs
    {
        private static readonly Job[] jobs = new Job[]
        {
            ...
            new Job() {ID = JobIDs.GNB, Role = Roles.Tank, NameEN = "Gunbreaker", NameJA = "ガンブレイカー", NameFR = "Pistosabreur", NameDE = "Revolverklinge" , NameCN = "绝枪战士", NameKO = "건브레이커", IsPopular = true},
            new Job() {ID = JobIDs.DNC, Role = Roles.RangeDPS, NameEN = "Dancer", NameJA = "踊り子", NameFR = "Danseur", NameDE = "Tänzer" , NameCN = "舞者", NameKO = "무도가", IsPopular = true},
            new Job() {ID = JobIDs.RPR, Role = Roles.MeleeDPS, NameEN = "Reaper", NameJA = "リーパー", NameFR = "Faucheur", NameDE = "Schnitter" , NameCN = "钐镰客", NameKO = "리퍼", IsPopular = true},
            new Job() {ID = JobIDs.SGE, Role = Roles.Healer, NameEN = "Sage", NameJA = "賢者", NameFR = "Sage", NameDE = "Weiser" , NameCN = "贤者", NameKO = "현자", IsPopular = true},
            new Job() {ID = JobIDs.VPR, Role = Roles.MeleeDPS, NameEN = "Viper", NameJA = "ヴァイパー", NameFR = "Rôdeur vipère", NameDE = "Viper", NameCN = "蝰蛇剑士", NameKO = "바이퍼", IsPopular = true},
            new Job() {ID = JobIDs.PCT, Role = Roles.MagicDPS, NameEN = "Pictomancer", NameJA = "ピクトマンサー", NameFR = "Pictomancien", NameDE = "Piktomant", NameCN = "绘灵法师", NameKO = "픽토맨서", IsPopular = true}
        };
    ...
    {
        private static readonly Lazy<Dictionary<JobIDs, string>> LazyJobIDDictionary
            = new Lazy<Dictionary<JobIDs, string>>(() =>
            {
