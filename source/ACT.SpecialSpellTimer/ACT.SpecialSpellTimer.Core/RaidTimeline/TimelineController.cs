            ...
            TimelineTriggerModel tri)
        {
            ...
            lock (tri)
            {
                ...
                if (vnotices.Any())
                {
                    ...
                    {
                        vnotice.Timestamp = this.detectTime;
                ...
                if (inotices.Any())
                {
                    ...
                    {
                        inotice.Timestamp = this.detectTime;
                    }
                }
